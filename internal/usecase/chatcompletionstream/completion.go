...
import (
	"github.com/JoseHenriqueRG/chatservice/internal/domain/entity"
	"github.com/JoseHenriqueRG/chatservice/internal/domain/gateway"
...
func NewchatCompletionUseCase(chatGateway gateway.ChatGateway, openAiClient *openAiClient, stream chan ChatCompletionOutputDTO) *ChatCompletionUseCase{
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error){
	...
	if err != nil {
		return nil, erros.New("error creating chat completion: " + err.Error())
	}
...
func createNewChat(input ChatCompletionInputDTO) (*entity.Chat, err){
	...
	if err != nil {
		return nil, erros.New("error creating new chat: " + err.Error())
	}
	return chat, nil
}